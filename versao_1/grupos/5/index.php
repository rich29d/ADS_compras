<?php
    ...
    $result_curso = "SELECT * FROM clientes";
    ...
    $result_cursos = "SELECT * FROM clientes limit $incio, $quantidade_pg";
        ...
        <div class="wrapper">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            <li class="dropdown notifications-menu">
                                <a href="pages/contasReceber.php" class="dropdown-toggle">
                                    <i class="fa fa-bell-o"></i>
                                    <span class="label label-warning">
                                        <?php 
                                        $sql = mysqli_query($conexao, "select count(nfe) as qtd from clientes where status in ('aberto')") or die (mysql_error()); 
                                        $qtd =  $sql->fetch_array();
                                        echo $qtd['qtd'];
                                        ?>
                                    </span>
                            ...
                            <li class="dropdown tasks-menu">
                                <a href="#" class="dropdown-toggle">
                                    ...
                                    <span class="label label-danger">
                                        <?php 
                                        $sql = mysqli_query($conexao, "select count(nfe) as qtd from clientes where status in ('atraso')") or die (mysql_error()); 
                                        $qtd =  $sql->fetch_array();
                                        echo $qtd['qtd'];
                                        ?>
                                    </span>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="dist/img/user1-512x512.png" class="user-image" alt="User Image">
                                    <span class="hidden-xs">Nome do Usuário</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="dist/img/user3-720x720.png" class="img-circle" alt="User Image">
                                        <p>
                                            Nome do Usuário
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-right">
                                            <a href="login/sair.php" class="btn btn-default btn-flat">Sair</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
            ...
            <aside class="main-sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/creditoAnalise.html"><i class="fa fa-circle-o"></i> Análises em aberto</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/contasReceber.php"><i class="fa fa-circle-o"></i>Contas a Receber</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> Início</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="info-box bg-aqua">
                                <a href="pages/contasReceber.php" style="color: #fff"><span class="info-box-icon"><i class="ion ion-ios-list-outline"></i></span></a>
                                <div class="info-box-content">
                                    <span class="info-box-text">Análises realizadas</span>
                                    <span class="info-box-number">
                                        <?php 
                                        $sql = mysqli_query($conexao, "select count(nfe) as qtd from clientes") or die (mysql_error()); 
                                        $qtd =  $sql->fetch_array();
                                        echo $qtd['qtd'];
                                        ?>
                                    </span>
                    ...
                    Ultimos 30 dias
                        ...
                        <div class="col-md-3">
                            <div class="info-box bg-yellow">
                                <a href="pages/contasReceber.php" style="color: #fff"><span class="info-box-icon"><i class="ion ion-android-add"></i></span></a>
                                <div class="info-box-content">
                    ...
                    Todo período
                        ...
                        <div class="col-md-3">
                            <div class="info-box bg-green">
                                <a href="pages/contasReceber.php" style="color: #fff"><span class="info-box-icon"><i class="ion ion-android-done"></i></span></a>
                                <div class="info-box-content">
                                    <span class="info-box-text">Recebidos</span>
                                    <span class="info-box-number">
                                        <?php 
                                        $sql = mysqli_query($conexao, "select count(nfe) as qtd from clientes where status in ('pago')") or die (mysql_error()); 
                                        $qtd =  $sql->fetch_array();
                                        echo $qtd['qtd'];
                                        ?>
                                    </span>
                    ...
                    Ultimos 30 dias
                        ...
                        <div class="col-md-3">
                            <div class="info-box bg-red">
                                <a href="pages/contasReceber.php" style="color: #fff"><span class="info-box-icon"><i class="ion ion-android-close"></i></span></a>
                                <div class="info-box-content">
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Acompanhamento Mensal</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-3">
                                            ...
                                            <div class="chart">
                                                <canvas id="barChartAnalises" style="height:230px"></canvas>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <p class="text-center">
                                            ...
                                            <div class="chart">
                                                <canvas id="barChartAbertos" style="height:230px"></canvas>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <p class="text-center">
                                            ...
                                            <div class="chart">
                                                <canvas id="barChartRecebidos" style="height:230px"></canvas>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-3">
                                            <p class="text-center">
                                            ...
                                            <div class="chart">
                                                <canvas id="barChartAtrasados" style="height:230px"></canvas>
                                            </div>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 col-xs-6">
                                            <div class="description-block border-right">
                                                <span class="description-percentage text-red" style="font-size: 40px;"><i class="fa fa-caret-down"></i> 10%</span>
                                        ...
                                        <div class="col-sm-3 col-xs-6">
                                            <div class="description-block border-right">
                                                <span class="description-percentage text-green" style="font-size: 30px;"><i class="fa fa-caret-up"></i> 25%</span>
                                                <h5 class="description-header"></h5>
                                                <span class="description-text"></span>
                                            </div>
                                            <!-- /.description-block -->
                                        ...
                                        <div class="col-sm-3 col-xs-6">
                                            <div class="description-block border-right">
                                                <span class="description-percentage text-red" style="font-size: 25px;"><i class="fa fa-caret-down"></i> 25%</span>
                                                <h5 class="description-header"></h5>
                                                <span class="description-text"></span>
                                            </div>
                                            <!-- /.description-block -->
                                        ...
                                        <div class="col-sm-3 col-xs-6">
                                            <div class="description-block">
                                                <span class="description-percentage text-yellow" style="font-size: 20px;"><i class="fa fa-caret-left"></i> 0%</span>
                                                <h5 class="description-header"></h5>
                                                <span class="description-text"></span>
                                            </div>
                                            <!-- /.description-block -->
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <?php $sql = mysqli_query($conexao, "select * from clientes where status in ('aberto')") or die (mysql_error()); ?>
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Próximos Recebimentos</h3>    <small>Recebimentos do Dia</small>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body no-padding">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <?php if($rows_cursos['status'] == 'aberto'){ ?>
                                        <tr>
                                            <td>
                                                <?php echo $rows_cursos['nfe']?>
                                            </td>
                                            <td>
                                                <?php echo $rows_cursos['nome']?>
                                            </td>
                                            <td>
                                                <?php echo $rows_cursos['tipoPag']?>
                                            </td>
                                            <td>
                                                <?php echo $rows_cursos['parcela']?>
                                            </td>
                                            <td>
                                                <?php echo $rows_cursos['valorParcela']?>
                                            </td>
                                            <td>
                                                <?php echo $rows_cursos['valorTotal']?>
                                            </td>
                                            <td>
                                                <?php echo $rows_cursos['dataVenda']?>
                                            </td>
                                            <td>
                                                <?php echo $rows_cursos['vencimento']?>
                                            </td>
                                            <td><span class="label label-warning"><?php echo $rows_cursos['status']?></span></td>
                                        </tr>
