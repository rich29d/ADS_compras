<?php
    ...
    $dadosCliente = mysqli_query($conexao, "select * from tbl_cliente where CNPJ_CPF = $cnpj_cpf_cliente");
    $linhaCliente = mysqli_fetch_assoc($dadosCliente);
    $totalCliente = mysqli_num_rows($dadosCliente);

    $dadosAnexo = mysqli_query($conexao, "select * from tbl_anexo where CNPJ_CPF = $cnpj_cpf_cliente");
	
    $linhaAnexo = mysqli_fetch_assoc($dadosAnexo);
    $totalAnexo= mysqli_num_rows($dadosAnexo);

    $anexo = $linhaAnexo["ANEXO"]; 

    if($totalCliente > 0){
        $cnpj_cpf = $linhaCliente["CNPJ_CPF"];
        $razao_social = $linhaCliente["NOME_RAZAOSOCIAL"];   
        $nome = $linhaCliente["CNPJ_CPF"];  
        $nacionalidade = $linhaCliente["NACIONALIDADE"];  
    }else{
...
<head>
  ...
  <title>Análise Individual</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Análise de Crédito
        <small>Análise Individual</small>
      </h1>
    </section>
    <!-- Main content -->
          ...
          <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><strong>Informações da Análise</strong></h3>
                ...
                <div class="box-body" style="padding: 0px;">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control"  value="<?php echo $nacionalidade?>">
                    </div>
                </div>
                <!-- ------------------ -->
                <!--       ANEXOS       -->
                ...
                <div class="box-body" style="padding: 0px;">
                    <div class="box-header with-border">
                        <h3 class="box-title"><br/>Documentos Anexados</h3>
                    </div><br>
                    <div class="form-group col-md-12">
                        <div class="col-md-2">
                            <div class="col-md-12" style="text-align: center; margin-top: 20px;">
                                <i class="fa fa-file-o" style="font-size: 52px;" aria-hidden="true"></i>
                                <br><br>
                                <a href="">Nome do Arquivo.pdf</a>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="col-md-12" style="text-align: center; margin-top: 20px;">
                ...
                <div class="box-body" style="padding: 0px;">
                    ...
                    <div class="form-group col-md-2">
                        <input type="button" class="btn btn-success" value="Salvar" style="margin-top:24px;">
                    </div>
                </div>
            </div>
          </div>
