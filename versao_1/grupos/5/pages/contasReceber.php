<?php
    ...
    include_once("../filtro/filtrar.php");
        ...
        <script>
            $(document).ready(function() {
                $("#btnFiltrar").click(function() {
                    $('.table-cliente-ativa').css('display');
                });
                ...
                $('#nome').keyup(function(){  
                  ...
                  $(document).on('click', 'input#nomeNovo', function(){  
                       $('#nome').val($(this).text());  
                       $('#nome').fadeOut();  
                  });
                ...
                $('#nfe').keyup(function(){  
                  ...
                  $(document).on('click', 'input#nfeNovo', function(){  
                       $('#nfe').val($(this).text());  
                       $('#nfe').fadeOut();  
                  }); 
            });
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            <li class="dropdown notifications-menu">
                                <a href="contasReceber.php" class="dropdown-toggle">
            ...
            <aside class="main-sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="contasReceber.php"><i class="fa fa-circle-o"></i>Contas a Receber</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="box collapsed-box" method="POST">
                                ...
                                <div class="box-body" action="<?php echo $_SERVER['PHP_SELF'];?>">
                                    <div class="form-group col-md-4">
                                        <label>NFe</label>
                                        <input type="text" class="form-control" name="parametro1" id="nfe">
                                        <div id="nfeList"></div>
                                    </div>
                                    <div class="form-group col-md-8">
                                        <label>Nome Cliente</label>
                                        <input type="text" class="form-control" name="parametro2" id="nome">
                                        <div id="nomeList"></div>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>Status</label>
                                        <select class="form-control" name="parametro3">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control" name="parametro4">
                                            Selecione...
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="parametro5">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>Valor Total</label>
                                        <input type="text" class="form-control" name="parametro6">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>Data da Venda</label>
                                        <input type="text" class="form-control" name="parametro7">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>Data do Vencimento</label>
                                        <input type="text" class="form-control" name="parametro8">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <?php if(isset($parametro3)){
                            if($parametro3 == "aberto"){
                                ?><div class="box box-warning"><?php
                            }else if($parametro3 == "pago"){
                                ?><div class="box box-success"><?php
                            }else if($parametro3 == "atraso"){
                                ?><div class="box box-danger"><?php
                            }else if($parametro3 == "todos"){
                                ?><div class="box box-primary"><?php
                            } }?>
                                <div class="box-body no-padding">
                        <table class="table table-bordered table-striped table-cliente-ativa">
                            <tr>
                                <th>NFe</th>
                                <th>Nome Cliente</th>
        ...
        ?>
                                ...
                                <tr>
                                    ...
                                    <?php $nome = substr($linha['nome'] , 0 , 46 ) ?>
                                    <td>
                                        <?php echo $nome ?>
                                    </td>
                                    <td>
                                        <?php echo $linha['tipoPag']?>
                                    </td>
                                    <td>
                                        <?php echo $linha['parcela']?>
                                    </td>
                                    <td>
                                        <?php echo $linha['valorParcela']?>
                                    </td>
                                    <!--<td>
                                        <?//php echo $linha['valorTotal']?>
                                    </td>
                                    <td>
                                        <?//php echo $linha['dataVenda']?>
                                    </td>-->
                                    <td>
                                    ...
                                    <td>
                                        <?php if($linha['status'] == "aberto"){
                                            ?><span class="label label-warning"><?php echo $linha['status'] ?></span><?php
                                        }else if($linha['status'] == "pago"){
                                            ?><span class="label label-success"><?php echo $linha['status'] ?></span><?php
                                        }else if($linha['status'] == "atraso"){
                                            ?><span class="label label-danger"><?php echo $linha['status'] ?></span><?php
                                        } ?>
                                    </td>
                                </tr>
